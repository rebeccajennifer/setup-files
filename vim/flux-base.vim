...
exe ':hi markdownH2       ctermfg ='.cli_red 'guifg = '.gui_yel 
exe ':hi markdownH2       cterm   =  bold     gui   =   bold'
exe ':hi markdownH3       ctermfg ='.cli_mag 'guifg = '.gui_mag 
...
exe ':hi markdownH1Delimiter      ctermfg ='.cli_cya 'guifg = '.gui_cya
exe ':hi markdownH2Delimiter      ctermfg ='.cli_blu 'guifg = '.gui_blu
exe ':hi markdownH3Delimiter      ctermfg ='.cli_mag 'guifg = '.gui_mag
exe ':hi markdownH4Delimiter      ctermfg ='.cli_red 'guifg = '.gui_red
